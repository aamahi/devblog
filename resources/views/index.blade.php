...
<body>
    ...
    <div class="main-wrapper">
	    ...
	    <section class="blog-list px-3 py-5 p-md-5">
		    <div class="container">
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="{{asset('frontend/assets/images/blog/blog-post-thumb-1.jpg')}}" alt="image">
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="{{asset('frontend/assets/images/blog/blog-post-thumb-2.jpg')}}" alt="image">
					    <div class="media-body">
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="{{asset('frontend/assets/images/blog/blog-post-thumb-3.jpg')}}" alt="image">
					    <div class="media-body">
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="{{asset('frontend/assets/images/blog/blog-post-thumb-4.jpg')}}" alt="image">
					    <div class="media-body">
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="{{asset('frontend/assets/images/blog/blog-post-thumb-5.jpg')}}" alt="image">
					    <div class="media-body">
			    ...
			    <div class="item">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="{{asset('frontend/assets/images/blog/blog-post-thumb-6.jpg')}}" alt="image">
					    <div class="media-body">
    ...
    <div id="config-panel" class="config-panel d-none d-lg-block">
        <div class="panel-inner">
            ...
            <ul id="color-options" class="list-inline mb-0">
                <li class="theme-1 active list-inline-item"><a data-style="{{asset('frontend/assets/css/theme-1.css')}}" href="#"></a></li>
                <li class="theme-2  list-inline-item"><a data-style="{{asset('frontend/assets/css/theme-2.css')}}" href="#"></a></li>
                <li class="theme-3  list-inline-item"><a data-style="{{asset('frontend/assets/css/theme-3.css')}}" href="#"></a></li>
                <li class="theme-4  list-inline-item"><a data-style="{{asset('frontend/assets/css/theme-4.css')}}" href="#"></a></li>
                <li class="theme-5  list-inline-item"><a data-style="{{asset('frontend/assets/css/theme-5.css')}}" href="#"></a></li>
                <li class="theme-6  list-inline-item"><a data-style="{{asset('frontend/assets/css/theme-6.css')}}" href="#"></a></li>
                <li class="theme-7  list-inline-item"><a data-style="{{asset('frontend/assets/css/theme-7.css')}}" href="#"></a></li>
                <li class="theme-8  list-inline-item"><a data-style="{{asset('frontend/assets/css/theme-8.css')}}" href="#"></a></li>
            </ul>
    ...
    <!-- Javascript -->
    <script src="{{asset('frontend/assets/plugins/jquery-3.3.1.min.js')}}"></script>
    <script src="{{asset('frontend/assets/plugins/popper.min.js')}}"></script>
    <script src="{{asset('frontend/assets/plugins/bootstrap/js/bootstrap.min.js')}}"></script>

    <!-- Style Switcher (REMOVE ON YOUR PRODUCTION SITE) -->
    <script src="{{asset('frontend/assets/js/demo/style-switcher.js')}}"></script>
