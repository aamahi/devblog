        ...
        <ul class="nav top-menu">
            ...
            <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    ...
                    <span class="badge badge-success">{{\App\Model\Category::count()}}</span>
                </a>
                <ul class="dropdown-menu extended tasks-bar">
                    <div class="notify-arrow notify-arrow-green"></div>
                    <li>
                        <p class="green">Total Category {{\App\Model\Category::count()}} </p>
                    </li>
...
{{--                        <a href="#">--}}
{{--                            <div class="task-info">--}}
{{--                                <div class="desc text-center text-info">{{$category->category_name}}</div>--}}
{{--                            </div>--}}
{{--                        </a>--}}
{{--                    </li>--}}
{{--                    @endforeach--}}
                    <li class="external">
                        <a href="{{route('category')}}">See All Category</a>
                    </li>
                </ul>
            </li>
            <!-- settings end -->
